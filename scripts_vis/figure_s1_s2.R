...
q <- q_1 / q_2 + plot_annotation(tag_levels = "a")
q

ggsave("figure/figure_s1.png", height = 8, width = 12)
ggsave("figure/figure_s1.pdf", height = 8, width = 12, device=cairo_pdf)

p_lm
ggsave("figure/figure_s2.png", height = 6, width = 13)
ggsave("figure/figure_s2.pdf", height = 6, width = 13, device=cairo_pdf)
